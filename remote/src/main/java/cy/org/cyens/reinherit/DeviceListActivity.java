        ...
        if (pairedDevices.size() > 0) {
            ...
            for (BluetoothDevice device : pairedDevices) {
                ...
                if(BluetoothFragment.DeviceDictionary.containsKey(device.getAddress())){
                    ...
                    BluetoothFragment.DeviceDictionary.put(device.getAddress(), tempDeviceName);
                }
                pairedDevicesArrayAdapter.add(tempDeviceName + "\n" + tempMacAddress); //maybe check the paired devices in the device dictionary here
            }
        } else {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (BluetoothDevice.ACTION_FOUND.equals(action)) {
                ...
                if (device != null && device.getBondState() != BluetoothDevice.BOND_BONDED) {
                    ...
                    BluetoothFragment.DeviceDictionary.put(device.getAddress(), deviceName);
                }
